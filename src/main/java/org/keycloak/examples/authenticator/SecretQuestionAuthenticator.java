...
public class SecretQuestionAuthenticator implements Authenticator {
    ...
    protected boolean validateAnswer(AuthenticationFlowContext context) {
        ...
        input.setType(SecretQuestionCredentialProvider.SECRET_QUESTION_2);
    ...
    public boolean configuredFor(KeycloakSession session, RealmModel realm, UserModel user) {
        return session.userCredentialManager().isConfiguredFor(realm, user, SecretQuestionCredentialProvider.SECRET_QUESTION_2);
    }
